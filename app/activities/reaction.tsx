      ...
      <ScrollView contentContainerStyle={{ paddingHorizontal: 20, paddingTop: 16, paddingBottom: 40 }} showsVerticalScrollIndicator={false}>
        ...
        {activeTab === 0 && (
          <View>
            ...
            <View style={{ width: "100%", height: 160, borderRadius: 12, marginBottom: 14, backgroundColor: "#EFF6FF", alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: "#BFDBFE" }}>
                <Text style={{ fontSize: 52 }}>⚡</Text>
                <Text style={{ fontSize: 14, color: "#3B82F6", fontWeight: "600", marginTop: 8 }}>Reaction Board Challenge</Text>
              </View>
        ...
        {activeTab === 4 && (
          <View>
            <Card>
              <Title>📈 Reaction Time Trend</Title>
              <ResultsChart
                type="line"
                description="Average reaction time (ms) improving across rounds — powered by react-native-chart-kit"
              />
            </Card>
